...
module.exports = {
  ...
  theme: {
    ...
    fontSize: {
      ...
      xl: ["21px", { lineHeight: "28px", letterSpacing: "0px" }],
      "2xl": ["25px", { lineHeight: "31px", letterSpacing: "0px" }],
      "3xl": ["31px", { lineHeight: "36px", letterSpacing: "0px" }],
      "4xl": ["40px", { lineHeight: "43px", letterSpacing: "0px" }],
      "5xl": ["54px", { lineHeight: "55px", letterSpacing: "0px" }],
      "6xl": ["72px", { lineHeight: "72px", letterSpacing: "0px" }],
      "7xl": ["92px", { lineHeight: "90px", letterSpacing: "0px" }],
    },
    extend: {
      colors: {
